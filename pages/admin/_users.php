...
<table width="100%" border="0">
  ...
  <tr>
    <td style="padding-left:10px;">собрано (свинья):</td>
...
?>
<form action="/?menu=helpmyadmin&sel=users&search" method="post">
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  <tr bgcolor="#efefef">
    <td align="center" width="50" class="m-tb"><a href="/?menu=helpmyadmin&sel=users&sort=0" class="stn-sort">ID</a></td>
    <td align="center" class="m-tb"><a href="/?menu=helpmyadmin&sel=users&sort=1" class="stn-sort">User</a></td>
    <td align="center" width="90" class="m-tb"><a href="/?menu=helpmyadmin&sel=users&sort=2" class="stn-sort">Серебра</a></td>
	<td align="center" width="75" class="m-tb"><a href="/?menu=helpmyadmin&sel=users&sort=3" class="stn-sort">Деревьев</a></td>
	<td align="center" width="100" class="m-tb"><a href="/?menu=helpmyadmin&sel=users&sort=4" class="stn-sort">Зарегистрирован</a></td>
  </tr>
...
<?PHP
    ...
    <td align="center"><a href="/?menu=helpmyadmin&sel=users&edit=<?=$data["id"]; ?>" class="stn"><?=$data["user"]; ?></a></td>
...
$all_pages = $db->FetchRow();
	...
	echo "<BR /><center>".$nav->Navigation(10, $page, ceil($all_pages / 100), "/?menu=helpmyadmin&sel=users&sort={$sort_b}&page="), "</center>";

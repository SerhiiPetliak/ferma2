...
if(isset($_GET["sel"])){
	...
	case "shop": include("pages/account/_shop.php"); break; // Моя ферма
        ...
        case "jobs_my": include("pages/account/_jobs_my.php"); break; // Задания
        case "jobs_add": include("pages/account/_jobs_add.php"); break; // Задания
        case "jobs_management": include("pages/account/_jobs_management.php"); break; // Задания
        case "jobs_show": include("pages/account/_jobs_show.php"); break; // Задания
        case "jobs_statistic": include("pages/account/_jobs_statistic.php"); break; // Задания

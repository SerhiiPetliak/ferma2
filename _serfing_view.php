...
{ 
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <frameset onLoad="javascript: frame_footer.startClock();" rows="*,70" style="height: 5vh; border: none;">
       <frame name="frame_site" src="/serfframe.php?url=<?php echo $result['url']; ?>" marginwidth="0" marginheight="0" frameborder="0" />
       <frame name="frame_footer" src="http://ferma/serf-fblock.php?cnt=<?php echo $_SESSION['view']['cnt']; ?>" marginwidth="0" marginheight="0" scrolling="no" noresize="noresize" frameborder="0" />
   </frameset>

...
$lang = array_merge($lang, array(
	...
	'DB_UPDATE_NOT_SUPPORTED'		=> 'К сожалению, данный сценарий не поддерживает обновление с версий phpBB до «%1$s». Установленная Вами версия — «%2$s». Обновите предыдущую версию перед выполнением данного сценария. Помощь по данному вопросу можно получить на сайте phpBB.com. Или на www.phpbbguru.net, сайте русской поддержки phpBB.',

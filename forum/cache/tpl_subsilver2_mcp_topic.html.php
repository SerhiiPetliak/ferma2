...
<!-- begin mod: Prime Trash Bin --><?php if ($this->_rootref['S_TOPIC_DELETED']) {  ?>

<tr class="deleted_topic">
	<th colspan="3" align="center"><?php echo ((isset($this->_rootref['L_PRIME_TOPIC_DELETED_MSG'])) ? $this->_rootref['L_PRIME_TOPIC_DELETED_MSG'] : ((isset($user->lang['PRIME_TOPIC_DELETED_MSG'])) ? $user->lang['PRIME_TOPIC_DELETED_MSG'] : '{ PRIME_TOPIC_DELETED_MSG }')); ?></th>
</tr>
<tr class="deleted_topic">
	<td class="row1" colspan="3" align="center"><table><tr><td align="left"><div class="postbody"><div class="ignore"><?php echo (isset($this->_rootref['DELETED_MSG'])) ? $this->_rootref['DELETED_MSG'] : ''; ?></div></div></td></tr></table></td>
</tr>
<?php } ?><!-- end mod: Prime Trash Bin -->
<tr>
...
<?php $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; ?><!-- begin mod: Prime Trash Bin --><?php if (!($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1<?php if ($_postrow_val['S_DELETED']) {  ?> deleted_post<?php } ?>"><?php } else { ?><tr class="row2<?php if ($_postrow_val['S_DELETED']) {  ?> deleted_post<?php } ?>"><?php } ?><!-- end mod: Prime Trash Bin -->
...
<!-- begin mod: Prime Trash Bin --><?php if (!($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1<?php if ($_postrow_val['S_DELETED']) {  ?> deleted_post<?php } ?>"><?php } else { ?><tr class="row2<?php if ($_postrow_val['S_DELETED']) {  ?> deleted_post<?php } ?>"><?php } ?><!-- end mod: Prime Trash Bin -->
...
<tr>
	<td class="cat" colspan="3" align="center"><select name="action"><option value="" selected="selected"><?php echo ((isset($this->_rootref['L_SELECT_ACTION'])) ? $this->_rootref['L_SELECT_ACTION'] : ((isset($user->lang['SELECT_ACTION'])) ? $user->lang['SELECT_ACTION'] : '{ SELECT_ACTION }')); ?></option>
		<?php if ($this->_rootref['S_CAN_APPROVE']) {  ?><option value="approve"><?php echo ((isset($this->_rootref['L_APPROVE_POSTS'])) ? $this->_rootref['L_APPROVE_POSTS'] : ((isset($user->lang['APPROVE_POSTS'])) ? $user->lang['APPROVE_POSTS'] : '{ APPROVE_POSTS }')); ?></option><?php } if ($this->_rootref['S_CAN_LOCK']) {  ?><option value="lock_post"><?php echo ((isset($this->_rootref['L_LOCK_POST_POSTS'])) ? $this->_rootref['L_LOCK_POST_POSTS'] : ((isset($user->lang['LOCK_POST_POSTS'])) ? $user->lang['LOCK_POST_POSTS'] : '{ LOCK_POST_POSTS }')); ?> [ <?php echo ((isset($this->_rootref['L_LOCK_POST_EXPLAIN'])) ? $this->_rootref['L_LOCK_POST_EXPLAIN'] : ((isset($user->lang['LOCK_POST_EXPLAIN'])) ? $user->lang['LOCK_POST_EXPLAIN'] : '{ LOCK_POST_EXPLAIN }')); ?> ]</option><option value="unlock_post"><?php echo ((isset($this->_rootref['L_UNLOCK_POST_POSTS'])) ? $this->_rootref['L_UNLOCK_POST_POSTS'] : ((isset($user->lang['UNLOCK_POST_POSTS'])) ? $user->lang['UNLOCK_POST_POSTS'] : '{ UNLOCK_POST_POSTS }')); ?></option><?php } ?><!-- begin mod: Prime Trash Bin --><?php if ($this->_rootref['S_CAN_UNDELETE']) {  ?><option value="undelete_post"><?php echo ((isset($this->_rootref['L_PRIME_UNDELETE_POSTS'])) ? $this->_rootref['L_PRIME_UNDELETE_POSTS'] : ((isset($user->lang['PRIME_UNDELETE_POSTS'])) ? $user->lang['PRIME_UNDELETE_POSTS'] : '{ PRIME_UNDELETE_POSTS }')); ?></option><?php } ?><!-- end mod: Prime Trash Bin --><?php if ($this->_rootref['S_CAN_MERGE']) {  ?><option value="merge_posts"<?php if ($this->_rootref['ACTION'] == ('merge')) {  ?> selected="selected"<?php } ?>><?php echo ((isset($this->_rootref['L_MERGE_POSTS'])) ? $this->_rootref['L_MERGE_POSTS'] : ((isset($user->lang['MERGE_POSTS'])) ? $user->lang['MERGE_POSTS'] : '{ MERGE_POSTS }')); ?></option><?php } if ($this->_rootref['S_CAN_SPLIT']) {  ?><option value="split_all"<?php if ($this->_rootref['ACTION'] == ('split')) {  ?> selected="selected"<?php } ?>><?php echo ((isset($this->_rootref['L_SPLIT_POSTS'])) ? $this->_rootref['L_SPLIT_POSTS'] : ((isset($user->lang['SPLIT_POSTS'])) ? $user->lang['SPLIT_POSTS'] : '{ SPLIT_POSTS }')); ?></option><option value="split_beyond"><?php echo ((isset($this->_rootref['L_SPLIT_AFTER'])) ? $this->_rootref['L_SPLIT_AFTER'] : ((isset($user->lang['SPLIT_AFTER'])) ? $user->lang['SPLIT_AFTER'] : '{ SPLIT_AFTER }')); ?></option><?php } ?>

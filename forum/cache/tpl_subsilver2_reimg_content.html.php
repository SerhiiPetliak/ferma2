...
<?php if ($this->_rootref['S_REIMG']) {  ?>
	...
	var reimg_loadingImg = "<?php if ($this->_rootref['REIMG_LOADING_IMG_SRC']) {  echo (isset($this->_rootref['REIMG_LOADING_IMG_SRC'])) ? $this->_rootref['REIMG_LOADING_IMG_SRC'] : ''; } else { echo (isset($this->_rootref['T_IMAGES_PATH'])) ? $this->_rootref['T_IMAGES_PATH'] : ''; ?>spacer.gif<?php } ?>";
	var reimg_loadingStyle = "<?php if ($this->_rootref['REIMG_LOADING_IMG_SRC']) {  if ($this->_rootref['REIMG_LOADING_IMG_WIDTH']) {  ?>width: <?php echo (isset($this->_rootref['REIMG_LOADING_IMG_WIDTH'])) ? $this->_rootref['REIMG_LOADING_IMG_WIDTH'] : ''; ?>px; <?php } if ($this->_rootref['REIMG_LOADING_IMG_HEIGHT']) {  ?>height: <?php echo (isset($this->_rootref['REIMG_LOADING_IMG_HEIGHT'])) ? $this->_rootref['REIMG_LOADING_IMG_HEIGHT'] : ''; ?>px; <?php } } else { ?>width: 18px; height: 15px; background: orange; <?php } ?>filter: Alpha(Opacity=50); opacity: .50;";
	...
	<?php if ($this->_rootref['S_REIMG_ZOOM']) {  if ($this->_rootref['S_REIMG_LINK']) {  ?>
		...
		<?php } if ($this->_rootref['S_REIMG_BUTTON']) {  ?>
			...
			var reimg_zoomImg = "<?php if ($this->_rootref['REIMG_ZOOM_IN_IMG_SRC']) {  echo (isset($this->_rootref['REIMG_ZOOM_IN_IMG_SRC'])) ? $this->_rootref['REIMG_ZOOM_IN_IMG_SRC'] : ''; } else { echo (isset($this->_rootref['T_IMAGES_PATH'])) ? $this->_rootref['T_IMAGES_PATH'] : ''; ?>spacer.gif<?php } ?>";
			var reimg_zoomStyle = "<?php if ($this->_rootref['REIMG_ZOOM_IN_IMG_SRC']) {  if ($this->_rootref['REIMG_ZOOM_IN_IMG_WIDTH']) {  ?>width: <?php echo (isset($this->_rootref['REIMG_ZOOM_IN_IMG_WIDTH'])) ? $this->_rootref['REIMG_ZOOM_IN_IMG_WIDTH'] : ''; ?>px; <?php } if ($this->_rootref['REIMG_ZOOM_IN_IMG_HEIGHT']) {  ?>height: <?php echo (isset($this->_rootref['REIMG_ZOOM_IN_IMG_HEIGHT'])) ? $this->_rootref['REIMG_ZOOM_IN_IMG_HEIGHT'] : ''; ?>px; <?php } } else { ?>width: 18px; height: 15px; background: green; <?php } ?>filter: Alpha(Opacity=45); opacity: .45;";
...
<?php if ($this->_rootref['S_REIMG']) {  ?>
	...
	<?php } else { ?>
		...
		<?php if ($this->_rootref['S_REIMG_LITEBOX'] == ('_litebox')) {  if ($this->_rootref['S_REIMG_BUTTON']) {  ?>
			...
			<?php } else { ?>
				...
				var litebox_zoomImg = "<?php if ($this->_rootref['REIMG_ZOOM_IN_IMG_SRC']) {  echo (isset($this->_rootref['REIMG_ZOOM_IN_IMG_SRC'])) ? $this->_rootref['REIMG_ZOOM_IN_IMG_SRC'] : ''; } else { echo (isset($this->_rootref['T_IMAGES_PATH'])) ? $this->_rootref['T_IMAGES_PATH'] : ''; ?>spacer.gif<?php } ?>";
				var litebox_zoomStyle = "<?php if ($this->_rootref['REIMG_ZOOM_IN_IMG_SRC']) {  if ($this->_rootref['REIMG_ZOOM_IN_IMG_WIDTH']) {  ?>width: <?php echo (isset($this->_rootref['REIMG_ZOOM_IN_IMG_WIDTH'])) ? $this->_rootref['REIMG_ZOOM_IN_IMG_WIDTH'] : ''; ?>px; <?php } if ($this->_rootref['REIMG_ZOOM_IN_IMG_HEIGHT']) {  ?>height: <?php echo (isset($this->_rootref['REIMG_ZOOM_IN_IMG_HEIGHT'])) ? $this->_rootref['REIMG_ZOOM_IN_IMG_HEIGHT'] : ''; ?>px; <?php } } else { ?>width: 18px; height: 15px; background: green; <?php } ?>filter: Alpha(Opacity=45); opacity: .45;";
				var litebox_zoomHover = "filter: Alpha(Opacity=90); opacity: .90;";
			<?php } ?>
		...
		<?php } if ($this->_rootref['S_REIMG_BUTTON']) {  ?>
			...
			var litebox_closeImg = "<?php if ($this->_rootref['REIMG_ZOOM_OUT_IMG_SRC']) {  echo (isset($this->_rootref['REIMG_ZOOM_OUT_IMG_SRC'])) ? $this->_rootref['REIMG_ZOOM_OUT_IMG_SRC'] : ''; } else { echo (isset($this->_rootref['T_IMAGES_PATH'])) ? $this->_rootref['T_IMAGES_PATH'] : ''; ?>spacer.gif<?php } ?>";
			var litebox_closeStyle = "<?php if ($this->_rootref['REIMG_ZOOM_OUT_IMG_SRC']) {  if ($this->_rootref['REIMG_ZOOM_OUT_IMG_WIDTH']) {  ?>width: <?php echo (isset($this->_rootref['REIMG_ZOOM_OUT_IMG_WIDTH'])) ? $this->_rootref['REIMG_ZOOM_OUT_IMG_WIDTH'] : ''; ?>px; <?php } if ($this->_rootref['REIMG_ZOOM_OUT_IMG_HEIGHT']) {  ?>height: <?php echo (isset($this->_rootref['REIMG_ZOOM_OUT_IMG_HEIGHT'])) ? $this->_rootref['REIMG_ZOOM_OUT_IMG_HEIGHT'] : ''; ?>px; <?php } } else { ?>width: 18px; height: 15px; background: red; <?php } ?>filter: Alpha(Opacity=45); opacity: .45;";

		...
		<?php if (!($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>
			...
			<?php } ?>
				...
				<span class="postdetails">
					...
					<?php }} ?><!-- begin mod: User reputation points - subsilver2 --><?php if ($this->_rootref['S_REPUTATION'] && $_postrow_val['S_USER_REPUTATION']) {  if ($this->_rootref['S_REP_DISPLAY'] != ('block')) {  ?><br /><strong><?php echo ((isset($this->_rootref['L_RP_TOTAL_POINTS'])) ? $this->_rootref['L_RP_TOTAL_POINTS'] : ((isset($user->lang['RP_TOTAL_POINTS'])) ? $user->lang['RP_TOTAL_POINTS'] : '{ RP_TOTAL_POINTS }')); ?>:</strong> <?php echo $_postrow_val['REPUTATION_TEXT']; } if ($this->_rootref['S_REP_DISPLAY'] != ('text')) {  ?><br /><?php if ($_postrow_val['U_VIEW_REP']) {  ?><a href="<?php echo $_postrow_val['U_VIEW_REP']; ?>" onclick="popup(this.href, 780, 550); return false;" ><?php } echo $_postrow_val['REPUTATION_BLOCK']; if ($_postrow_val['U_VIEW_REP']) {  ?></a><?php } } if ($_postrow_val['S_GIVE_REPUTATION']) {  ?><br /><a href="<?php echo $_postrow_val['U_ADD_POS']; ?>"><img src="<?php echo (isset($this->_rootref['T_IMAGES_PATH'])) ? $this->_rootref['T_IMAGES_PATH'] : ''; ?>reputation/add.png" title="<?php echo ((isset($this->_rootref['L_RP_ADD_POINTS'])) ? $this->_rootref['L_RP_ADD_POINTS'] : ((isset($user->lang['RP_ADD_POINTS'])) ? $user->lang['RP_ADD_POINTS'] : '{ RP_ADD_POINTS }')); ?> <?php echo $_postrow_val['POST_AUTHOR']; ?>" alt="<?php echo ((isset($this->_rootref['L_RP_ADD_POINTS'])) ? $this->_rootref['L_RP_ADD_POINTS'] : ((isset($user->lang['RP_ADD_POINTS'])) ? $user->lang['RP_ADD_POINTS'] : '{ RP_ADD_POINTS }')); ?> <?php echo $_postrow_val['POST_AUTHOR']; ?>" /></a><?php if ($_postrow_val['S_GIVE_NEGATIVE']) {  ?><a href="<?php echo $_postrow_val['U_ADD_NEG']; ?>"><img src="<?php echo (isset($this->_rootref['T_IMAGES_PATH'])) ? $this->_rootref['T_IMAGES_PATH'] : ''; ?>reputation/subtract.png" title="<?php echo ((isset($this->_rootref['L_RP_SUBTRACT_POINTS'])) ? $this->_rootref['L_RP_SUBTRACT_POINTS'] : ((isset($user->lang['RP_SUBTRACT_POINTS'])) ? $user->lang['RP_SUBTRACT_POINTS'] : '{ RP_SUBTRACT_POINTS }')); ?> <?php echo $_postrow_val['POST_AUTHOR']; ?>" alt="<?php echo ((isset($this->_rootref['L_RP_SUBTRACT_POINTS'])) ? $this->_rootref['L_RP_SUBTRACT_POINTS'] : ((isset($user->lang['RP_SUBTRACT_POINTS'])) ? $user->lang['RP_SUBTRACT_POINTS'] : '{ RP_SUBTRACT_POINTS }')); ?> <?php echo $_postrow_val['POST_AUTHOR']; ?>" /></a><?php } } } ?><!-- end mod: User reputation points - subsilver2 --><?php if ($_postrow_val['POSTER_WARNINGS'] && sizeof($_postrow_val['warnings'])) {  ?><span class="postdetails"><br /><b><?php echo ((isset($this->_rootref['L_WARNINGS'])) ? $this->_rootref['L_WARNINGS'] : ((isset($user->lang['WARNINGS'])) ? $user->lang['WARNINGS'] : '{ WARNINGS }')); ?>:</b> <?php echo $_postrow_val['POSTER_WARNINGS']; ?></span><?php $_warnings_count = (isset($_postrow_val['warnings'])) ? sizeof($_postrow_val['warnings']) : 0;if ($_warnings_count) {for ($_warnings_i = 0; $_warnings_i < $_warnings_count; ++$_warnings_i){$_warnings_val = &$_postrow_val['warnings'][$_warnings_i]; ?><div title="<?php echo ((isset($this->_rootref['L_WARNINGS'])) ? $this->_rootref['L_WARNINGS'] : ((isset($user->lang['WARNINGS'])) ? $user->lang['WARNINGS'] : '{ WARNINGS }')); ?>" style="float:left;margin:2px 2px 2px 0;width:20px;height:20px;line-height:20px;text-align:center;background:url('<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/warning_card.gif') no-repeat 50%;cursor:default;"><?php echo $_warnings_val['COUNT']; ?></div><?php }} } ?>

...
<div id="pagecontent">
	...
	<tr>
		<td class="row1" align="center">
			<?php $_warnings_count = (isset($this->_tpldata['warnings'])) ? sizeof($this->_tpldata['warnings']) : 0;if ($_warnings_count) {for ($_warnings_i = 0; $_warnings_i < $_warnings_count; ++$_warnings_i){$_warnings_val = &$this->_tpldata['warnings'][$_warnings_i]; ?><div title="<?php echo ((isset($this->_rootref['L_WARNINGS'])) ? $this->_rootref['L_WARNINGS'] : ((isset($user->lang['WARNINGS'])) ? $user->lang['WARNINGS'] : '{ WARNINGS }')); ?>" style="float:right;margin-left:2px;width:20px;height:20px;line-height:20px;text-align:center;background:url('<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/warning_card.gif') no-repeat 50%;cursor:default;"><?php echo $_warnings_val['COUNT']; ?></div><?php }} ?>
		...
		<td class="row1">
			...
			<!-- begin mod: User reputation points - subsilver2 --><?php if ($this->_rootref['S_REPUTATION']) {  ?>

			<tr>
				<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="top" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_RP_TOTAL_POINTS'])) ? $this->_rootref['L_RP_TOTAL_POINTS'] : ((isset($user->lang['RP_TOTAL_POINTS'])) ? $user->lang['RP_TOTAL_POINTS'] : '{ RP_TOTAL_POINTS }')); ?>: </td>
				<td><b class="gen"><?php echo (isset($this->_rootref['REPUTATION'])) ? $this->_rootref['REPUTATION'] : ''; ?></b></td>
			</tr>
			<tr>
				<td class="gen" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="top" nowrap="nowrap"><?php echo ((isset($this->_rootref['L_RP_POWER'])) ? $this->_rootref['L_RP_POWER'] : ((isset($user->lang['RP_POWER'])) ? $user->lang['RP_POWER'] : '{ RP_POWER }')); ?>: </td>
				<td><b class="gen"><?php echo (isset($this->_rootref['REP_POWER'])) ? $this->_rootref['REP_POWER'] : ''; ?></b></td>
			</tr>
			<?php } ?><!-- end mod: User reputation points - subsilver2 --><?php if ($this->_rootref['S_SHOW_ACTIVITY']) {  ?>
	...
	<tr>
		...
		<td class="row1">
			...
			<tr>
				...
				<td><?php if ($this->_rootref['U_WWW']) {  ?><b><a class="genmed" href="<?php echo (isset($this->_rootref['U_WWW'])) ? $this->_rootref['U_WWW'] : ''; ?>" <?php echo (isset($this->_rootref['EXTERNAL_LINK_TARGET'])) ? $this->_rootref['EXTERNAL_LINK_TARGET'] : ''; ?>><?php echo (isset($this->_rootref['U_WWW'])) ? $this->_rootref['U_WWW'] : ''; ?></a></b><?php } ?></td>
			</tr>

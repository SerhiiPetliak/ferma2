...
<?php } ?><!-- begin mod: User reputation points - subsilver2 --><?php if (sizeof($this->_tpldata['reputation_row'])) {  ?>

<tr>
	<th colspan="3"><?php echo ((isset($this->_rootref['L_RP_RECENT_POINTS'])) ? $this->_rootref['L_RP_RECENT_POINTS'] : ((isset($user->lang['RP_RECENT_POINTS'])) ? $user->lang['RP_RECENT_POINTS'] : '{ RP_RECENT_POINTS }')); ?></th>
</tr>
<tr>
	<td class="row1" colspan="3">
		<table width="100%" cellspacing="1" cellpadding="4">
		<tr class="row3">
			<td><b class="genmed"><?php echo ((isset($this->_rootref['L_RP_POINTS'])) ? $this->_rootref['L_RP_POINTS'] : ((isset($user->lang['RP_POINTS'])) ? $user->lang['RP_POINTS'] : '{ RP_POINTS }')); ?></b></td>
			<td><b class="genmed"><?php echo ((isset($this->_rootref['L_RP_COMMENTS'])) ? $this->_rootref['L_RP_COMMENTS'] : ((isset($user->lang['RP_COMMENTS'])) ? $user->lang['RP_COMMENTS'] : '{ RP_COMMENTS }')); ?></b></td>
			<td><b class="genmed"><?php echo ((isset($this->_rootref['L_RP_FROM'])) ? $this->_rootref['L_RP_FROM'] : ((isset($user->lang['RP_FROM'])) ? $user->lang['RP_FROM'] : '{ RP_FROM }')); ?></b></td>
			<td><b class="genmed"><?php echo ((isset($this->_rootref['L_POSTS'])) ? $this->_rootref['L_POSTS'] : ((isset($user->lang['POSTS'])) ? $user->lang['POSTS'] : '{ POSTS }')); ?></b></td>
		</tr>
		<?php $_reputation_row_count = (isset($this->_tpldata['reputation_row'])) ? sizeof($this->_tpldata['reputation_row']) : 0;if ($_reputation_row_count) {for ($_reputation_row_i = 0; $_reputation_row_i < $_reputation_row_count; ++$_reputation_row_i){$_reputation_row_val = &$this->_tpldata['reputation_row'][$_reputation_row_i]; if (!($_reputation_row_val['S_ROW_COUNT'] & 1)  ) {  ?><tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>

			<td><span class="genmed"><?php echo $_reputation_row_val['POINT_IMG']; ?></span></td>
			<td><span class="genmed"><?php echo $_reputation_row_val['COMMENT']; ?></span></td>
			<td><span class="genmed"><?php echo $_reputation_row_val['FROM']; ?></span></td>
			<td><span class="genmed"><?php if ($_reputation_row_val['POST_SUBJECT']) {  ?><a href="<?php echo $_reputation_row_val['U_POST']; ?>"><?php echo $_reputation_row_val['POST_SUBJECT']; ?></span></a><?php } else { echo ((isset($this->_rootref['L_RP_NA'])) ? $this->_rootref['L_RP_NA'] : ((isset($user->lang['RP_NA'])) ? $user->lang['RP_NA'] : '{ RP_NA }')); } ?></td>
		<?php }} ?>
...
<?php } ?><!-- end mod: User reputation points - subsilver2 -->
<tr>
...
<tr>
	<td class="row1" colspan="3">
		...
		<tr> 
			...
			<td><?php if ($this->_rootref['POSTS_PCT']) {  ?><b class="gen"><?php echo (isset($this->_rootref['POSTS'])) ? $this->_rootref['POSTS'] : ''; ?></b><br /><span class="genmed">[<?php echo (isset($this->_rootref['POSTS_PCT'])) ? $this->_rootref['POSTS_PCT'] : ''; ?> / <?php echo (isset($this->_rootref['POSTS_DAY'])) ? $this->_rootref['POSTS_DAY'] : ''; ?>]<?php if ($this->_rootref['S_DISPLAY_SEARCH']) {  ?><br /><a href="<?php echo (isset($this->_rootref['U_SEARCH_SELF'])) ? $this->_rootref['U_SEARCH_SELF'] : ''; ?>"><?php echo ((isset($this->_rootref['L_SEARCH_YOUR_POSTS'])) ? $this->_rootref['L_SEARCH_YOUR_POSTS'] : ((isset($user->lang['SEARCH_YOUR_POSTS'])) ? $user->lang['SEARCH_YOUR_POSTS'] : '{ SEARCH_YOUR_POSTS }')); ?></a><?php } ?></span><?php } else { ?><b class="gen"><?php echo (isset($this->_rootref['POSTS'])) ? $this->_rootref['POSTS'] : ''; ?><b><?php } ?></td>
		</tr>

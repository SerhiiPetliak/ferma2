...
<tr>
	...
	<td class="row2">
		...
		<?php } if (! $this->_rootref['S_PRIVMSGS']) {  if ($this->_rootref['S_LOCK_TOPIC_ALLOWED']) {  ?>
			...
			<?php } if ($this->_rootref['S_FIRST_POST_SHOW_ALLOWED']) {  ?>

				<tr>
					<td><input type="checkbox" class="radio" name="topic_first_post_show"<?php echo (isset($this->_rootref['S_FIRST_POST_SHOW_CHECKED'])) ? $this->_rootref['S_FIRST_POST_SHOW_CHECKED'] : ''; ?> /></td>
					<td class="gen"><?php echo ((isset($this->_rootref['L_FIRST_POST_SHOW'])) ? $this->_rootref['L_FIRST_POST_SHOW'] : ((isset($user->lang['FIRST_POST_SHOW'])) ? $user->lang['FIRST_POST_SHOW'] : '{ FIRST_POST_SHOW }')); ?></td>
				</tr>

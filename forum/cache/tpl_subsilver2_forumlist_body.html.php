	...
	<?php } else if ($_forumrow_val['S_IS_LINK']) {  ?>
		...
		<tr>
			...
			<td class="row1">
				...
				<a class="forumlink" href="<?php echo $_forumrow_val['U_VIEWFORUM']; ?>" <?php echo $_forumrow_val['EXTERNAL_LINK_TARGET']; ?>><?php echo $_forumrow_val['FORUM_NAME']; ?></a>
	...
	<?php } else { if ($_forumrow_val['S_NO_CAT']) {  ?>
		...
		<tr>
			...
			<td class="row2" align="center" nowrap="nowrap">
				<?php if ($_forumrow_val['LAST_POST_TIME']) {  if ($_forumrow_val['ALTT_LINK_NAME_SHORT']) {  ?><p><a <?php if ($_forumrow_val['ALTT_STYLE_BOLD'] || $_forumrow_val['ALTT_STYLE_ITALIC'] || $_forumrow_val['ALTT_STYLE_ADV']) {  ?>style="<?php if ($_forumrow_val['ALTT_STYLE_BOLD']) {  ?>font-weight: bold;<?php } if ($_forumrow_val['ALTT_STYLE_ITALIC']) {  ?>font-style: italic;<?php } if ($_forumrow_val['ALTT_STYLE_ADV']) {  echo $_forumrow_val['ALTT_STYLE_ADV2']; } ?>"<?php } ?> href="<?php echo $_forumrow_val['U_ALTT_LINK']; ?>" title="<?php echo $_forumrow_val['ALTT_LINK_NAME']; ?>"><?php echo $_forumrow_val['ALTT_LINK_NAME_SHORT']; ?></a></p><?php } ?>
